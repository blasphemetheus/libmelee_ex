...
| Research: Mewtwo teleport edge-cancel, Marth FrameData-spaced tipper, thunders combo as a GameEvents conversion, Peach FC measurement matrix | `mix test --only dolphin_research` | ExiAI headless (flush-patched) | ~28s, 4 boots; a double jump out of the teleport slide-off, tipper 18.2 vs 14.0, one 18.7%/5-move conversion |
